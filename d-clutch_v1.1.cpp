...
/// 3. добавить проверку на использование ; - / | *
/// 4. сделать возможность ввода названий с пробелом

//// остановился на: 5 залить всЁ на Гитхаб.
...
void manual(string FP) {
    ...
    // namespace fs = std::filesystem;
    // fs::path dirPath = fs::path(re).parent_path();

...
int main()
{
    ...
    // dividingPoints в функции (4)
    // dividingPoints в функции (1)
    // перенес и создал функцию void showPlannedExpenses();
    // сделал повторный вывод запланированных расходов в функции plannedExpenses().
